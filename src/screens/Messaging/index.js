...
const ArtisanList = connect(mapStateToProps, mapDispatchToProps)(UnconnectedMessageList)
const AddArtisan = connect(mapStateToProps, mapDispatchToProps)(UnconnectedMessage)
